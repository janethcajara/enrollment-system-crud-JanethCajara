...
async function loadStudents() {
    ...
    async function deleteStudent(id) {
        ...
        try {
            const res = await fetch('http://localhost/enrollment-system-crud-Janeth/api/Students/deleteStudent.php', {
                method: 'POST',
                headers: {'Content-Type': 'application/json'},
    ...
    async function populateProgramsTable() {
        ...
        try {
            const res = await fetch('http://localhost/enrollment-system-crud-Janeth/api/Programs/getPrograms.php');
            const data = await res.json();
            if (data.success) {
                tbody.innerHTML = '';
                data.data.forEach(p => {
    ...
    async function renderProgramForm(editData) {
        ...
        document.getElementById('program-form').onsubmit = async e => {
            ...
            try {
                let url = 'http://localhost/enrollment-system-crud-Janeth/api/Programs/addProgram.php';
                let body = {program_id, program_name, ins_id};
                if (editData) {
                    url = 'http://localhost/enrollment-system-crud-Janeth/api/Programs/updateProgram.php';
    ...
    async function deleteProgram(id) {
        ...
        try {
            const res = await fetch('http://localhost/enrollment-system-crud-Janeth/api/Programs/deleteProgram.php', {
                method: 'POST',
                headers: {'Content-Type': 'application/json'},
    ...
    async function loadYearsAndSemesters() {
        ...
        try {
            const res = await fetch('http://localhost/enrollment-system-crud-Janeth/api/Years&Semesters/getSemesters.php');
            const data = await res.json();
            if (data.success) {
    ...
    async function renderYearForm(editData) {
        ...
        document.getElementById('year-form').onsubmit = async e => {
            ...
            try {
                let url = 'http://localhost/enrollment-system-crud-Janeth/api/Years&Semesters/addYear.php';
                let body = {year_id, year_from, year_to};
                if (editData) {
                    url = 'http://localhost/enrollment-system-crud-Janeth/api/Years&Semesters/updateYear.php';
    ...
    async function renderSemesterForm(editData) {
        ...
        document.getElementById('semester-form').onsubmit = async e => {
            ...
            try {
                let url = 'http://localhost/enrollment-system-crud-Janeth/api/Years&Semesters/addSemester.php';
                let body = {sem_id, sem_name, year_id};
                if (editData) {
                    url = 'http://localhost/enrollment-system-crud-Janeth/api/Years&Semesters/updateSemester.php';
    ...
    async function deleteSemester(id) {
        ...
        try {
            const res = await fetch('http://localhost/enrollment-system-crud-Janeth/api/Years&Semesters/deleteSemester.php', {
                method: 'POST',
                headers: {'Content-Type': 'application/json'},
    ...
    async function loadSubjects() {
        ...
        try {
            const res = await fetch('http://localhost/enrollment-system-crud-Janeth/api/Subjects/getSubjects.php');
            const data = await res.json();
            if (data.success) {
                tbody.innerHTML = '';
                for (const s of data.data) {
    ...
    async function renderSubjectForm(editData) {
        ...
        document.getElementById('subject-form').onsubmit = async e => {
            ...
            try {
                let url = 'http://localhost/enrollment-system-crud-Janeth/api/Subjects/addSubject.php';
    ...
    async function deleteSubject(id) {
        ...
        try {
            const res = await fetch('http://localhost/enrollment-system-crud-Janeth/api/Subjects/deleteSubject.php', {
                method: 'POST',
                headers: {'Content-Type': 'application/json'},
    ...
    async function loadEnrollments() {
        ...
        try {
            const res = await fetch('http://localhost/enrollment-system-crud-Janeth/api/Enrollments/getEnrollments.php');
            const data = await res.json();
            if (data.success) {
                tbody.innerHTML = '';
                data.data.forEach(e => {
        ...
        document.getElementById('enrollment-form').onsubmit = async e => {
            ...
            try {
                ...
                if (editData) {
                    ...
                    url = 'http://localhost/enrollment-system-crud-Janeth/api/Enrollments/updateEnrollment.php';
    ...
    async function deleteEnrollment(id) {
        ...
        try {
            const res = await fetch('http://localhost/enrollment-system-crud-Janeth/api/Enrollments/removeEnrollment.php', {
                method: 'POST',
                headers: {'Content-Type': 'application/json'},
